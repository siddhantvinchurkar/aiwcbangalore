...
window.onload = function () {
	...
	$.when(
		...
		$('#s5p2').html('In the subsequent year, Mysore was incorporated into the state of Karnataka and it is during this period ‘Mysore State Women’s Conference’ was renamed as All India Women’s Conference, Bangalore Branch. The Bangalore branch experienced the zeal and vigor under the Presidentship of Lady Ramaswamy Mudaliar (1932), Mrs. R. A. Srinivas Iyengar (1973), Mrs. Bharathi Bai (1973), Mrs. Vilasini Nagesh (1998), Mrs. Nalinakshi Sanappa (2004), Mrs. Saroja Nanjappa (2010), Mrs. Sathyavathi Narayanan (2013), Mrs. Nirmala P. N. (2014) and, at present Mrs. Amitha Anand. These women along with many others who supported them worked tirelessly for the growth of the organization and betterment of the womenfolk. They soon became an active counterpart in the All India Women’s Movement.');
